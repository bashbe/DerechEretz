...
class ClasseForm(FlaskForm):
    ...
    annee_scolaire = StringField("Année scolaire", validators=[DataRequired()], default="2025-2026")
...
class CompteForm(FlaskForm):
    ...
    password = PasswordField("Mot de passe (laisser vide pour ne pas modifier)", validators=[Optional()])
...
class AnneeScolaireForm(FlaskForm):
    libelle = StringField("Libellé (ex : 2025-2026)", validators=[DataRequired()])
